...
from langchain.libs.core.langchain_core.pydantic_v1 import BaseConfig, BaseModel, Field, create_model
...
from langchain.libs.core.langchain_core.runnables.graph import Graph
...
from langchain.libs.core.langchain_core.utils.aiter import atee, py_anext
from langchain.libs.core.langchain_core.utils.iter import safetee
...
if TYPE_CHECKING:
    ...
    from langchain.libs.core.langchain_core.runnables.fallbacks import (
        RunnableWithFallbacks as RunnableWithFallbacksT,
    )
    from langchain.libs.core.langchain_core.tracers.log_stream import RunLog, RunLogPatch
    from langchain.libs.core.langchain_core.tracers.root_listeners import Listener
    ...
    * Async: Methods with "a" suffix are asynchronous. By default, they execute
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from langchain.libs.core.langchain_core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from langchain.libs.core.langchain_core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, List[str]]) -> RunnableSerializable[Any, Any]:
        ...
        from langchain.libs.core.langchain_core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        Returns a new runnable."""
        from langchain.libs.core.langchain_core.runnables.passthrough import RunnableAssign
    ...
    async def astream_log(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain.libs.core.langchain_core.callbacks.base import BaseCallbackManager
    ...
    def with_listeners(
        ...
        *,
        ...
        added to the run.
        """
        from langchain.libs.core.langchain_core.tracers.root_listeners import RootListenersTracer
    ...
    def with_retry(
        ...
        *,
        ...
        """
        from langchain.libs.core.langchain_core.runnables.retry import RunnableRetry
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        from langchain.libs.core.langchain_core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        from langchain.libs.core.langchain_core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from langchain.libs.core.langchain_core.runnables.passthrough import RunnableAssign, RunnablePick
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from langchain.libs.core.langchain_core.output_parsers.json import SimpleJsonOutputParser
    ...
    def invoke(self, input: Input, config: Optional[RunnableConfig] = None) -> Output:
        from langchain.libs.core.langchain_core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from langchain.libs.core.langchain_core.beta.runnables.context import aconfig_with_context
...
class RunnableBinding(RunnableBindingBase[Input, Output]):
    ...
    `bind`: Bind kwargs to pass to the underlying runnable when running it.
        ...
        .. code-block:: python
            ...
            from langchain.libs.langchain.langchain.schema.runnable import RunnableBinding
