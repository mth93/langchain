...
from langchain.libs.core.langchain_core._api.deprecation import deprecated
...
from langchain.libs.core.langchain_core.pydantic_v1 import BaseModel, SecretStr, root_validator
