...
class HypotheticalDocumentEmbedder:
    def __init__(self, *args: Any, **kwargs: Any):
        logger.warning(
            ...
            "`from langchain.libs.langchain.langchain.chains import HypotheticalDocumentEmbedder` instead"
        )
        from langchain.libs.langchain.langchain.chains.hyde.base import HypotheticalDocumentEmbedder as H
