...
from langchain.libs.core.langchain_core.globals import get_debug as core_get_debug
from langchain.libs.core.langchain_core.globals import get_verbose as core_get_verbose
