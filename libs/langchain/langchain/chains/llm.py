...
from langchain.libs.core.langchain_core.language_models import (
    BaseLanguageModel,
    LanguageModelInput,
)
...
from langchain.libs.core.langchain_core.output_parsers import BaseLLMOutputParser, StrOutputParser
