...
from langchain.libs.langchain.langchain.utilities.requests import Requests, RequestsWrapper, TextRequestsWrapper


def _import_alpha_vantage() -> Any:
    from langchain.libs.langchain.langchain.utilities.alpha_vantage import AlphaVantageAPIWrapper

    return AlphaVantageAPIWrapper


def _import_apify() -> Any:
    from langchain.libs.langchain.langchain.utilities.apify import ApifyWrapper

    return ApifyWrapper


def _import_arcee() -> Any:
    from langchain.libs.langchain.langchain.utilities.arcee import ArceeWrapper
...
def _import_bibtex() -> Any:
    from langchain.libs.langchain.langchain.utilities.bibtex import BibtexparserWrapper
...
def _import_brave_search() -> Any:
    from langchain.libs.langchain.langchain.utilities.brave_search import BraveSearchWrapper
...
def _import_google_places_api() -> Any:
    from langchain.libs.langchain.langchain.utilities.google_places_api import GooglePlacesAPIWrapper
...
def _import_jira() -> Any:
    from langchain.libs.langchain.langchain.utilities.jira import JiraAPIWrapper

    return JiraAPIWrapper


def _import_max_compute() -> Any:
    from langchain.libs.langchain.langchain.utilities.max_compute import MaxComputeAPIWrapper
...
def _import_outline() -> Any:
    from langchain.libs.langchain.langchain.utilities.outline import OutlineAPIWrapper

    return OutlineAPIWrapper


def _import_portkey() -> Any:
    from langchain.libs.langchain.langchain.utilities.portkey import Portkey

    return Portkey


def _import_powerbi() -> Any:
    from langchain.libs.langchain.langchain.utilities.powerbi import PowerBIDataset
...
def _import_python() -> Any:
    from langchain.libs.langchain.langchain.utilities.python import PythonREPL

    return PythonREPL


def _import_scenexplain() -> Any:
    from langchain.libs.langchain.langchain.utilities.scenexplain import SceneXplainAPIWrapper
...
def _import_spark_sql() -> Any:
    from langchain.libs.langchain.langchain.utilities.spark_sql import SparkSQL
...
def _import_steam_webapi() -> Any:
    from langchain.libs.langchain.langchain.utilities.steam import SteamWebAPIWrapper
...
def _import_tensorflow_datasets() -> Any:
    from langchain.libs.langchain.langchain.utilities.tensorflow_datasets import TensorflowDatasets
...
def _import_zapier() -> Any:
    from langchain.libs.langchain.langchain.utilities.zapier import ZapierNLAWrapper

    return ZapierNLAWrapper


def _import_nasa() -> Any:
    from langchain.libs.langchain.langchain.utilities.nasa import NasaAPIWrapper
