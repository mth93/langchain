...
def _import_ai21() -> Any:
    from langchain.libs.langchain.langchain.llms.ai21 import AI21

    return AI21


def _import_aleph_alpha() -> Any:
    from langchain.libs.langchain.langchain.llms.aleph_alpha import AlephAlpha

    return AlephAlpha


def _import_amazon_api_gateway() -> Any:
    from langchain.libs.langchain.langchain.llms.amazon_api_gateway import AmazonAPIGateway

    return AmazonAPIGateway


def _import_anthropic() -> Any:
    from langchain.libs.langchain.langchain.llms.anthropic import Anthropic

    return Anthropic


def _import_anyscale() -> Any:
    from langchain.libs.langchain.langchain.llms.anyscale import Anyscale

    return Anyscale


def _import_arcee() -> Any:
    from langchain.libs.langchain.langchain.llms.arcee import Arcee

    return Arcee


def _import_aviary() -> Any:
    from langchain.libs.langchain.langchain.llms.aviary import Aviary

    return Aviary


def _import_azureml_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.azureml_endpoint import AzureMLOnlineEndpoint

    return AzureMLOnlineEndpoint


def _import_baidu_qianfan_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.baidu_qianfan_endpoint import QianfanLLMEndpoint

    return QianfanLLMEndpoint


def _import_bananadev() -> Any:
    from langchain.libs.langchain.langchain.llms.bananadev import Banana

    return Banana


def _import_baseten() -> Any:
    from langchain.libs.langchain.langchain.llms.baseten import Baseten

    return Baseten


def _import_beam() -> Any:
    from langchain.libs.langchain.langchain.llms.beam import Beam
...
def _import_bittensor() -> Any:
    from langchain.libs.langchain.langchain.llms.bittensor import NIBittensorLLM

    return NIBittensorLLM


def _import_cerebriumai() -> Any:
    from langchain.libs.langchain.langchain.llms.cerebriumai import CerebriumAI

    return CerebriumAI


def _import_chatglm() -> Any:
    from langchain.libs.langchain.langchain.llms.chatglm import ChatGLM

    return ChatGLM


def _import_clarifai() -> Any:
    from langchain.libs.langchain.langchain.llms.clarifai import Clarifai

    return Clarifai


def _import_cohere() -> Any:
    from langchain.libs.langchain.langchain.llms.cohere import Cohere

    return Cohere


def _import_ctransformers() -> Any:
    from langchain.libs.langchain.langchain.llms.ctransformers import CTransformers

    return CTransformers


def _import_ctranslate2() -> Any:
    from langchain.libs.langchain.langchain.llms.ctranslate2 import CTranslate2

    return CTranslate2


def _import_databricks() -> Any:
    from langchain.libs.langchain.langchain.llms.databricks import Databricks
...
def _import_deepinfra() -> Any:
    from langchain.libs.langchain.langchain.llms.deepinfra import DeepInfra

    return DeepInfra


def _import_deepsparse() -> Any:
    from langchain.libs.langchain.langchain.llms.deepsparse import DeepSparse

    return DeepSparse


def _import_edenai() -> Any:
    from langchain.libs.langchain.langchain.llms.edenai import EdenAI
...
def _import_forefrontai() -> Any:
    from langchain.libs.langchain.langchain.llms.forefrontai import ForefrontAI

    return ForefrontAI


def _import_gigachat() -> Any:
    from langchain.libs.langchain.langchain.llms.gigachat import GigaChat

    return GigaChat


def _import_google_palm() -> Any:
    from langchain.libs.langchain.langchain.llms.google_palm import GooglePalm

    return GooglePalm


def _import_gooseai() -> Any:
    from langchain.libs.langchain.langchain.llms.gooseai import GooseAI

    return GooseAI


def _import_gpt4all() -> Any:
    from langchain.libs.langchain.langchain.llms.gpt4all import GPT4All

    return GPT4All


def _import_gradient_ai() -> Any:
    from langchain.libs.langchain.langchain.llms.gradient_ai import GradientLLM

    return GradientLLM


def _import_huggingface_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.huggingface_endpoint import HuggingFaceEndpoint

    return HuggingFaceEndpoint


def _import_huggingface_hub() -> Any:
    from langchain.libs.langchain.langchain.llms.huggingface_hub import HuggingFaceHub
...
def _import_huggingface_text_gen_inference() -> Any:
    from langchain.libs.langchain.langchain.llms.huggingface_text_gen_inference import (
...
def _import_human() -> Any:
    from langchain.libs.langchain.langchain.llms.human import HumanInputLLM

    return HumanInputLLM


def _import_javelin_ai_gateway() -> Any:
    from langchain.libs.langchain.langchain.llms.javelin_ai_gateway import JavelinAIGateway

    return JavelinAIGateway


def _import_koboldai() -> Any:
    from langchain.libs.langchain.langchain.llms.koboldai import KoboldApiLLM

    return KoboldApiLLM


def _import_llamacpp() -> Any:
    from langchain.libs.langchain.langchain.llms.llamacpp import LlamaCpp

    return LlamaCpp


def _import_manifest() -> Any:
    from langchain.libs.langchain.langchain.llms.manifest import ManifestWrapper

    return ManifestWrapper


def _import_minimax() -> Any:
    from langchain.libs.langchain.langchain.llms.minimax import Minimax

    return Minimax


def _import_mlflow() -> Any:
    from langchain.libs.langchain.langchain.llms.mlflow import Mlflow
...
def _import_mlflow_ai_gateway() -> Any:
    from langchain.libs.langchain.langchain.llms.mlflow_ai_gateway import MlflowAIGateway

    return MlflowAIGateway


def _import_modal() -> Any:
    from langchain.libs.langchain.langchain.llms.modal import Modal

    return Modal


def _import_mosaicml() -> Any:
    from langchain.libs.langchain.langchain.llms.mosaicml import MosaicML

    return MosaicML


def _import_nlpcloud() -> Any:
    from langchain.libs.langchain.langchain.llms.nlpcloud import NLPCloud

    return NLPCloud


def _import_octoai_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.octoai_endpoint import OctoAIEndpoint

    return OctoAIEndpoint


def _import_ollama() -> Any:
    from langchain.libs.langchain.langchain.llms.ollama import Ollama

    return Ollama


def _import_opaqueprompts() -> Any:
    from langchain.libs.langchain.langchain.llms.opaqueprompts import OpaquePrompts

    return OpaquePrompts


def _import_azure_openai() -> Any:
    from langchain.libs.langchain.langchain.llms.openai import AzureOpenAI
...
def _import_openai_chat() -> Any:
    from langchain.libs.langchain.langchain.llms.openai import OpenAIChat

    return OpenAIChat


def _import_openllm() -> Any:
    from langchain.libs.langchain.langchain.llms.openllm import OpenLLM

    return OpenLLM


def _import_openlm() -> Any:
    from langchain.libs.langchain.langchain.llms.openlm import OpenLM

    return OpenLM


def _import_pai_eas_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.pai_eas_endpoint import PaiEasEndpoint

    return PaiEasEndpoint


def _import_petals() -> Any:
    from langchain.libs.langchain.langchain.llms.petals import Petals

    return Petals


def _import_pipelineai() -> Any:
    from langchain.libs.langchain.langchain.llms.pipelineai import PipelineAI

    return PipelineAI


def _import_predibase() -> Any:
    from langchain.libs.langchain.langchain.llms.predibase import Predibase

    return Predibase


def _import_predictionguard() -> Any:
    from langchain.libs.langchain.langchain.llms.predictionguard import PredictionGuard

    return PredictionGuard


def _import_promptlayer() -> Any:
    from langchain.libs.langchain.langchain.llms.promptlayer_openai import PromptLayerOpenAI

    return PromptLayerOpenAI


def _import_promptlayer_chat() -> Any:
    from langchain.libs.langchain.langchain.llms.promptlayer_openai import PromptLayerOpenAIChat

    return PromptLayerOpenAIChat


def _import_replicate() -> Any:
    from langchain.libs.langchain.langchain.llms.replicate import Replicate

    return Replicate


def _import_rwkv() -> Any:
    from langchain.libs.langchain.langchain.llms.rwkv import RWKV

    return RWKV


def _import_sagemaker_endpoint() -> Any:
    from langchain.libs.langchain.langchain.llms.sagemaker_endpoint import SagemakerEndpoint

    return SagemakerEndpoint


def _import_self_hosted() -> Any:
    from langchain.libs.langchain.langchain.llms.self_hosted import SelfHostedPipeline

    return SelfHostedPipeline


def _import_self_hosted_hugging_face() -> Any:
    from langchain.libs.langchain.langchain.llms.self_hosted_hugging_face import SelfHostedHuggingFaceLLM

    return SelfHostedHuggingFaceLLM


def _import_stochasticai() -> Any:
    from langchain.libs.langchain.langchain.llms.stochasticai import StochasticAI

    return StochasticAI


def _import_symblai_nebula() -> Any:
    from langchain.libs.langchain.langchain.llms.symblai_nebula import Nebula

    return Nebula


def _import_textgen() -> Any:
    from langchain.libs.langchain.langchain.llms.textgen import TextGen

    return TextGen


def _import_titan_takeoff() -> Any:
    from langchain.libs.langchain.langchain.llms.titan_takeoff import TitanTakeoff

    return TitanTakeoff


def _import_titan_takeoff_pro() -> Any:
    from langchain.libs.langchain.langchain.llms.titan_takeoff_pro import TitanTakeoffPro

    return TitanTakeoffPro


def _import_together() -> Any:
    from langchain.libs.langchain.langchain.llms.together import Together

    return Together


def _import_tongyi() -> Any:
    from langchain.libs.langchain.langchain.llms.tongyi import Tongyi

    return Tongyi


def _import_vertex() -> Any:
    from langchain.libs.langchain.langchain.llms.vertexai import VertexAI

    return VertexAI


def _import_vertex_model_garden() -> Any:
    from langchain.libs.langchain.langchain.llms.vertexai import VertexAIModelGarden

    return VertexAIModelGarden


def _import_vllm() -> Any:
    from langchain.libs.langchain.langchain.llms.vllm import VLLM

    return VLLM


def _import_vllm_openai() -> Any:
    from langchain.libs.langchain.langchain.llms.vllm import VLLMOpenAI

    return VLLMOpenAI


def _import_watsonxllm() -> Any:
    from langchain.libs.langchain.langchain.llms.watsonxllm import WatsonxLLM

    return WatsonxLLM


def _import_writer() -> Any:
    from langchain.libs.langchain.langchain.llms.writer import Writer

    return Writer


def _import_xinference() -> Any:
    from langchain.libs.langchain.langchain.llms.xinference import Xinference

    return Xinference


def _import_yandex_gpt() -> Any:
    from langchain.libs.langchain.langchain.llms.yandex import YandexGPT

    return YandexGPT


def _import_volcengine_maas() -> Any:
    from langchain.libs.langchain.langchain.llms.volcengine_maas import VolcEngineMaasLLM
