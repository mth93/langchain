...
from langchain.libs.langchain.langchain.chat_models import ChatVertexAI
...
from langchain.libs.core.langchain_core.runnables import RunnableLambda, RunnableParallel
